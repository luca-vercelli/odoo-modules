...
XSD_FILENAME = DIRNAME + "/data/730_precompilata.xsd"
WSDL_PROD = DIRNAME + "/data/InvioTelematicoSpeseSanitarie730p.wsdl"
WSDL_TEST = DIRNAME + "/data/InvioTelematicoSpeseSanitarie730pTest.wsdl"
WSDL_ESITO = DIRNAME + "/data/EsitoInvioDatiSpesa730Service.wsdl"
WSDL_DET_ERRORI = DIRNAME + "/data/DettaglioErrori730Service.wsdl"
WSDL_RICEVUTE = DIRNAME + "/data/RicevutaPdf730Service.wsdl"

PUBLIC_KEY_PEM_FILENAME = DIRNAME + "/data/SanitelCF.cer"
PUBLIC_KEY = None
